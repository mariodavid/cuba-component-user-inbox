...
public class DdcuiTestContainer extends TestContainer {

    public DdcuiTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "de/diedavids/cuba/userinbox/app.properties",
    ...
    public static class Common extends DdcuiTestContainer {

        public static final DdcuiTestContainer.Common INSTANCE = new DdcuiTestContainer.Common();
